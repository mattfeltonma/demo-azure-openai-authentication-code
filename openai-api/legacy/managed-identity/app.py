...
def main():
    ...
    ## The variables loaded include AZURE_OPENAI_ENDPOINT, DEPLOYMENT_NAME, 
    ## OPENAI_API_VERSION, and optionally MANAGED_IDENTITY_CLIENT_ID if using a user-assigned managed identity
    try:
        load_dotenv('.env')
    except Exception as e:
